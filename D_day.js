function alarm() {
    ...
    return "[ 시험일정 ]"  
        ...
        //+ "\n9월 모평: " + D_day("Aug 31, 2022") + " || 8.31"
        //+ "\n중간고사: " + D_day("Sep 5, 2022") + " || 9.5"
        + "\n기말고사: " + D_day("Oct 4, 2022") + " || 10.4~7"
        + "\n10월 학평: " + D_day("Oct 12, 2022") + " || 10.12"
        + "\n수능: " + D_day("Nov 17, 2022") + " || 11.17"

        + "\n\n[ 기타 일정 ]"
        //+ "\n추석연휴: " + D_day("Sep 9, 2022") + " || 9.9 (금)"
        + "\n개천절: " + D_day("Oct 3, 2022") + " || 10.3 (월)";
}
